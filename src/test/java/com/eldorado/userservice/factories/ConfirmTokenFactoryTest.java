...
class ConfirmTokenFactoryTest {

	@InjectMocks
	private ConfirmTokenFactory confirmTokenFactory;
	@InjectMocks
	...
	void test() {
		...
		// when
		ConfirmationToken tokenObserved = confirmTokenFactory.createConfirmationToken(user);
		// then
		assertTrue(tokenObserved instanceof ConfirmationToken);
	}
